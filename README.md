...
также для его работы скачайтк zebar вот в этом репозитории: https://github.com/glzr-io/zebar

тажке справа будет releases и скачивайте подходящий вам, я скачивала - v3.2.0 Installer (Windows x64)
